      ...
      <div className="flex-grow">
        ...
        {Cart && Cart.length > 0 && (
          <div className="h-auto">
            ...
            {Cart.map((items, i) => (
              <div
                className="w-full my-4 rounded flex flex-col md:flex-row p-4 bg-[#0A1828] justify-between items-center"
                key={i}
              >
                <img
                  src={items.url}
                ...
                <div className="w-full md:w-auto mt-4 md:mt-0 md:ml-4">
                  <h1 className="text-xl md:text-2xl text-[#FFD700] font-semibold text-start">
                    {items.title}
                  </h1>
                  <p className="text-sm md:text-normal text-[#FFD700] mt-2 hidden lg:block">
                    {items.desc.slice(0, 100)}...
                  </p>
                  <p className="text-sm md:text-normal text-[#FFD700] mt-2 hidden md:block lg:hidden">
                    {items.desc.slice(0, 65)}...
                  </p>
                  <p className="text-sm md:text-normal text-[#FFD700] mt-2 block md:hidden">
                    {items.desc.slice(0, 50)}...
                  </p>
                </div>
                <div className="flex mt-4 w-full md:w-auto items-center justify-between md:justify-start">
                  <h2 className="text-[#FFD700] text-2xl md:text-3xl font-semibold flex">
                    ৳ {items.price}
                  </h2>
                  <button
              ...
              <div className="mt-4 w-full flex intem-center justify-end">
                <div className="p-4 bg-[#0A1828] rounded">
                  ...
                  <div className="mt-3 flex items-center justify-between text-xl text-white">
                    <h2>{Cart.length} Books </h2> <h2 className="text-[#FFD700]">৳ {Total}</h2>
                  </div>
